 	  ...
 	  {	  
 	  	  ...
 	  	  if(ae.getSource()==login)
	      {
		   ...
		   /*if(cntr)
		   {
		   	...
		   	if(flag<0)
		   	{
		   			JOptionPane.showMessageDialog(null,"Plaese enter valid UserId!!","Error!Error!!",JOptionPane.ERROR_MESSAGE); 
		   			u_idt.setText(null);
		   			cntr=false;	
		   	}
		   }*/
		...
		/*   if(cntr)
		   {
		   		...
		   		if(nm.length()==0&&un.length()!=0&&ps.length()!=0)
		   		{
		  			JOptionPane.showMessageDialog(null,"Enter the UserId please!!","Error!Error!!",JOptionPane.ERROR_MESSAGE); 
		  			cntr=false;
		   		}
		   ...
		   /*if(cntr)
		   {
		   		JOptionPane.showMessageDialog(null,"Not connected to  Database!!","Error!Error!!",JOptionPane.ERROR_MESSAGE); 
		   		cntr=false;
		   }*/
